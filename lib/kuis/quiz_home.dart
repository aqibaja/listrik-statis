    ...
    final List<Widget> _list = [
      ...
      SliderBox(
        child: QuizView(
          ...
          wrongAnswers: ["Listrik Statis", "Medan Listrik", "Energi Listrik"],
          onRightAnswer: () => print("Right"),
          onWrongAnswer: () => print("Wrong"),
          nexTap: () {
            int nextPage = _controller.page!.round() + 1;
      ...
      SliderBox(
          child: QuizView(
              ...
              dataJawaban: htmlData5, jawabanImage: true,)),
      SliderBox(
          child: QuizView(
              image: Container(
                child: Image.asset(
              ...
              dataJawaban: htmlData6, jawabanImage: true,)),
      SliderBox(
          child: QuizView(
              showCorrect: true,
              tagColor: Colors.black,
              ...
              height: 600,
              question:
                  "Siapakah ilmuwan yang pertama kali mencetuskan tentang petir terjadi akibat adanya gejala listrik ?",
      ...
      SliderBox(
          child: QuizView(
              ...
              dataJawaban: htmlData8, jawabanImage: true,)),
      SliderBox(
          child: QuizView(
              showCorrect: true,
              tagColor: Colors.black,
